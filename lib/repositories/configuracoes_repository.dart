...
class ConfiguracoesRepository {
  ...
  void salvar(ConfiguracoesModel configuracoesModel) {
    _box.put('configuracoesModel', {
      'nomeUsuario': configuracoesModel.getNomeUsuario,
      'altura': configuracoesModel.getAltura,
      'recebeNotificacoes': configuracoesModel.getReceberNotificacoes,
      'temaEscuro': configuracoesModel.getTemaEscuro,
    });
  }
  ...
  ConfiguracoesModel obterDados() {
    ...
    if (configuracoes == null) {
      ...
      return ConfiguracoesModel(
          ...
          configuracoes["recebeNotificacoes"],
